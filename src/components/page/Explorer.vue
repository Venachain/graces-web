                        ...
                        <el-table-column :width="220">
                            <template slot-scope="scope">
                                ...
                                <div class="bk_icon_right">
                                    <router-link :to="'/block/' + scope.row.height + '/chain/' + chainId">{{ scope.row.height }}</router-link>
                        ...
                        <el-table-column show-overflow-tooltip>
                            <template slot-scope="scope">
                                ...
                                <div style="display: block">
                                    <router-link :to="'/tx/' + scope.row.id + '/block/' + chainId">{{ scope.row.tx_amount }}</router-link>
                    ...
                    <el-table :data="txList" max-height="550" :show-header="false">
                        <el-table-column :width="330" show-overflow-tooltip>
                            <template slot-scope="scope">
                                ...
                                <div class="bk_icon_right">
                                    <router-link :to="'/tx/' + scope.row.hash + '/chain/' + chainId" class="txhash">{{ scope.row.hash }}</router-link>
                                    <div>{{ scope.row.timestamp }}</div>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column show-overflow-tooltip>
                            <template slot-scope="scope">
                                <div class="txhash">
                                    ...
                                    <router-link :to = "'/tx/' + scope.row.from + '/participant/' + chainId">{{ scope.row.from }}</router-link>
                                </div>
                                <div class="txhash">
                                    <span style="font-weight: bold">To: </span>
                                    <router-link :to = "'/tx/' + scope.row.to + '/participant/' + chainId">{{ scope.row.to }}</router-link>
                                </div>
                            </template>
                        </el-table-column>
                    </el-table>
