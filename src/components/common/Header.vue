<template>
    <div class="header">
        ...
        <div class="logo">{{$t('i18n.system_name')}}</div>
        <div class="header-right">
            <div class="header-user-con">
                <!-- 全屏显示 -->
                <div class="btn-fullscreen" @click="handleFullScreen">
                    <el-tooltip effect="dark" :content="fullscreen?$t('i18n.cancel_fullScreen'):$t('i18n.fullScreen')" placement="bottom">
                ...
                <el-dropdown class="user-name" trigger="click" @command="handleCommand">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        ...
                        <!-- <el-dropdown-item divided command="loginout">{{$t('i18n.logout')}}</el-dropdown-item> -->
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
        </div>
